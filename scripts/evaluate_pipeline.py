#!/usr/bin/env python3
"""Convenience wrapper around the shared evaluation CLI."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run a configured Vison evaluation pipeline")
    ...
    argv = ["evaluate", "--config", str(config_path)]
    if args.checkpoint:
